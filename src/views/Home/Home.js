    ...
    return (
            ...
            <header>
                ...
                <div className="main-nav">
                    <nav className="menu" onClick={toggleBurgerMenu}>
                        ...
                        <a href="#features">Featuring</a>
                        <a href="#sales">Sales</a>
                        <a href="#roadmap">Roadmap</a>
                    </nav>
                    <nav className="buttons">
                        <a href="" className="btn btn-primary">Whitepaper</a>
                        <a href="" className="btn btn-secondary">CHARM App</a>
                    </nav>
                </div>
        ...
        <main>
            ...
            <section className="buy wrap spacing" id="buy">
                ...
                <a href="" data-aos="fade-up" data-aos-duration="1000" className="btn btn-primary">Buy CHARM</a>
            </section>
            ...
            <section className="team spacing">
                    ...
                    <div className="member">
                        ...
                        <div className="description">
                            ...
                            <nav className="socials">
                                ...
                                <a href=""><img src="./images/facebook.svg" alt="Linkedin Logo" /></a>
                                <a href=""><img src="./images/twitter.svg" alt="Linkedin Logo" /></a>
                            </nav>
                        </div>
                    </div>
                    <div className="member">
        ...
        <footer>
            <div className="wrap spacing">
                <div className="infos-footer">
                    ...
                    <p className="footer-title">CHARM - Uncensored NFC Platform</p>
                    <p>Adress :</p>
                    <p>Phone :</p>
